...
public class DefaultMapController extends JMapController
	...
	private static final int MOUSE_BUTTONS_MASK = InputEvent.BUTTON3_DOWN_MASK | InputEvent.BUTTON1_DOWN_MASK
	...
	private int movementMouseButtonMask = InputEvent.BUTTON1_DOWN_MASK;
	 ...
	 *
	 * @param movementEnabled {@code true} to allow the map pane to be moved using
	 *                        the mouse
	 */
	...
	public void setMovementMouseButton(int movementMouseButton) {
		...
		case MouseEvent.BUTTON1:
			movementMouseButtonMask = InputEvent.BUTTON1_DOWN_MASK;
			break;
		case MouseEvent.BUTTON2:
			movementMouseButtonMask = InputEvent.BUTTON2_DOWN_MASK;
			break;
		case MouseEvent.BUTTON3:
			movementMouseButtonMask = InputEvent.BUTTON3_DOWN_MASK;
			break;
		default:
